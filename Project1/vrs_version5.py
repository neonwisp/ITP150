...
while choice != "stop!":
    ...
    if choice == "go!":
        ...
        print("Cost Before Discount".ljust(25) + format(cost, "10.2f"))
        print("Age Discount".ljust(25) + format(discount, "10.2f"))
        print("Cost After Discount".ljust(25) + format(final_cost, "10.2f"))
